...
import com.texasholdem.tournament.application.hand.TournamentBetSizing;
...
public final class TournamentStateAccess {
    ...
    public TournamentPlayerState requirePlayer(TournamentState tournament, String guestId) {
    ...
    public TournamentPlayerState findPlayer(TournamentState tournament, String guestId) {
    ...
    public TournamentPlayerState requireSeatPlayer(TournamentState tournament, int seatIndex) {
        return tournament.players.stream()
    ...
    public long countRemainingParticipants(TournamentState tournament) {
        return tournament.players.stream()
    ...
    public long countContestingPlayers(TournamentState tournament) {
        return tournament.players.stream()
    ...
    public long countPlayersAbleToAct(TournamentState tournament) {
        return tournament.players.stream()
    ...
    public boolean allActivePlayersAreAfk(TournamentState tournament) {
    ...
    public List<Integer> remainingSeats(TournamentState tournament) {
        return tournament.players.stream()
                .filter(player -> player.participating && player.stack > 0)
    ...
    public int nextSeatFrom(List<Integer> seats, int currentSeat) {
        return seats.stream()
    ...
    public Integer nextActiveSeatAfter(TournamentState tournament, int currentSeat) {
    ...
    public Integer nextAwaitingSeatAfter(TournamentState tournament, int currentSeat) {
    ...
    public boolean canManuallyAct(TournamentPlayerState player) {
    ...
    public void pauseForAllPlayersAfk(TournamentState tournament) {
    ...
    public void resumePausedHand(TournamentState tournament) {
        if (!tournament.paused) {
            return;
        }
    ...
    public void clearPausedHand(TournamentState tournament) {
    ...
    public long currentLevelSecondsRemaining(TournamentState tournament) {
        if (tournament.paused) {
    ...
    public long currentLevelDurationSeconds(TournamentState tournament) {
    ...
    public void setActingPlayer(TournamentState tournament, Integer seatIndex) {
    ...
    public List<String> buildAvailableActions(TournamentState tournament, TournamentPlayerState player) {
    ...
    public String combineMessages(String... parts) {
