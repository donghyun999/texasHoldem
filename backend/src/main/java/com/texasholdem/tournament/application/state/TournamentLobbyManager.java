...
@Component
public final class TournamentLobbyManager {
    ...
    public TournamentState createTournament(
            String code,
            String roomName,
            String roomPassword,
            String guestId,
    ...
    public void joinTournament(TournamentState tournament, String guestId, String nickname) {
    ...
    public void changeReady(TournamentState tournament, String guestId, boolean ready) {
        stateAccess.requireWaiting(tournament);
    ...
    public void requireOwner(TournamentState tournament, String guestId) {
    ...
    public int startTournament(TournamentState tournament, String guestId) {
