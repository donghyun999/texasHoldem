...
@Component
public final class TournamentHandResultManager {
    ...
    public TournamentHandResultManager(
    ...
    public void settleCompletedHand(TournamentState tournament) {
    ...
    public String buildChampionMessage(TournamentState tournament, String prefixMessage) {
    ...
    public void moveToFinished(TournamentState tournament, String tableMessage) {
    ...
    public void moveToHandResult(TournamentState tournament, String tableMessage) {
