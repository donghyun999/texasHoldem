...
import com.texasholdem.tournament.application.hand.TournamentHandEngine;
...
@Component
public final class TournamentConnectionManager {
    ...
    public TournamentConnectionManager(
    ...
    public TournamentConnectionChange disconnect(TournamentState tournament, String guestId) {
    ...
    public TournamentConnectionChange reconnect(TournamentState tournament, String guestId) {
        var player = stateAccess.requirePlayer(tournament, guestId);
        if (player.connected) {
