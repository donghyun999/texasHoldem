...
@Component
public final class TournamentHandProgressManager {
    ...
    public TournamentHandProgressManager(
    ...
    public void refreshPots(TournamentState tournament) {
    ...
    public void activatePreflopAction(TournamentState tournament, String tableMessage) {
    ...
    public void advanceAfterProgress(
    ...
    public void applyForcedFoldAndAdvance(TournamentState tournament, TournamentPlayerState player, boolean preserveCurrentActingSeat) {
    ...
    public void resumePausedHandIfPossible(TournamentState tournament, TournamentPlayerState player) {
