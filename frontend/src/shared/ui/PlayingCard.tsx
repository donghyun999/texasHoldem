...
export function PlayingCard({ card, variant = "board" }: PlayingCardProps) {
  ...
  if (parsedCard.hidden) {
    return (
      ...
      >
        <div className="absolute inset-[4px] rounded-[inherit] border border-white/20 bg-[radial-gradient(circle_at_top,_rgba(255,255,255,0.16),_transparent_45%),repeating-linear-gradient(135deg,rgba(255,255,255,0.08)_0_6px,transparent_6px_12px)] sm:inset-[5px]" />
